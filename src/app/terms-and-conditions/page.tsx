  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="font-heading text-4xl text-primary text-center">Terms and Conditions</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none text-foreground">
          ...
          <h2 className="font-heading text-2xl text-primary">1. General Terms</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">2. Purchase and Redemption</h2>
          <ul>
          ...
          <h2 className="font-heading text-2xl text-primary">3. Expiration and Fees</h2>
          <p>
            Our gift cards do not expire. There are no activation, inactivity, or service fees associated with our gift cards.
          </p>

          <h2 className="font-heading text-2xl text-primary">4. Lost or Stolen Gift Cards</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">5. Delivery</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">6. Limitations</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">7. Governing Law</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">8. Changes to Terms</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl text-primary">Contact Us</h2>
          <p>
